        ...
        public void outputToXML(String strFile)
        {
            try
            {
                ...
                strXML.append("<properties>");
                    ...
                    strXML.append("\n\n");
                    strXML.append("<property name=\"alNames\" type=\"ArrayList[String]\" description=\"Contains proper nouns/names from text input\">");
                    loopCnt=alNames.size();
                    for(int i=0;i<loopCnt;i++)
                    {
                        strXML.append("\n");
                        strXML.append("<propertyValue index=\"" + i + "\">" + alNames.get(i) + "</propertyValue>");
                    }
                    strXML.append("\n");
                    strXML.append("</property>"); 
                    
                    //WORKER THREAD property - inner class
                    strXML.append("\n\n");
                    strXML.append("<property name=\"workerThread\" type=\"object\" description=\"workerThread inner class - spun off as a thread\">"); 
                    strXML.append("\n");
                    strXML.append("<innerObject>");
                        strXML.append("\n");
                        strXML.append("<properties>");
                        strXML.append("\n\n");
                        ...
                        strXML.append("\n\n");
                        strXML.append("<property name=\"strFile\" type=\"String\" description=\"String denoting input file (txt) for data (e.g. d01.txt)\">"); 
                        strXML.append("\n");
                        strXML.append("</property>");
                        
                        strXML.append("\n\n");
                        strXML.append("<property name=\"strOutFile\" type=\"String\" description=\"String denoting output file (XML) for data (e.g. d01.xml)\">"); 
                        strXML.append("\n");
                        strXML.append("</property>");  
                        strXML.append("\n");
                        strXML.append("</properties>"); 
                        ...
                        strXML.append("<methods>");  
                            strXML.append("\n");
                            strXML.append("<method name=\"WorkerThread\" parameters=\"[String],[String]\" description=\"WorkerThread Class Constructor\"></method>");
                            ...
                            strXML.append("\n");
                            strXML.append("<method name=\"getNames\" parameters=\"[String]\" description=\"Marks words that fall at the end of a sentence\"></method>");                    

                            strXML.append("\n");
                            strXML.append("<method name=\"isEndWord\" parameters=\"[String]\" description=\"Marks words that fall at the end of a sentence\"></method>");

                            strXML.append("\n");
                            strXML.append("<method name=\"outputToXML\" parameters=\"[String]\" description=\"Outputs object schema in readable XML\"></method>");     

                            strXML.append("\n");
                            strXML.append("<method name=\"processCommand\" parameters=\"\" description=\"Outputs object schema in readable XML\"></method>");          

                            strXML.append("\n");
                            strXML.append("<method name=\"run\" parameters=\"\" description=\"Outputs object schema in readable XML\"></method>");   

                            strXML.append("\n");
                            strXML.append("<method name=\"tagNames\" parameters=\"\" description=\"Marks proper nouns/names in sentences by surrounding with properNoun tags\"></method>"); 
                            
                            strXML.append("\n");
                            strXML.append("<method name=\"writeToFile\" parameters=\"[String],[String]\" description=\"Writes data to a file\"></method>");                            
                        ...
                        strXML.append("</innerObject>");
                        strXML.append("\n");
                        strXML.append("</property>"); //End WORKER THREAD property - inner class
                        strXML.append("\n");
                strXML.append("</properties>");                
                ...
                strXML.append("<methods>");  
                        strXML.append("\n");
                        strXML.append("<method name=\"createFolder\" parameters=\"[String]\" description=\"Creates output folder if it doesn't exist\"></method>");  
    ...
    public void outputToXML()
    {
        try
        {
            ...
            strXML.append("<methods>");  
                ...
                strXML.append("\n");
                strXML.append("<method name=\"getByWord\" parameters=\"[String]\" description=\"Gets words from text input and stores in ArrayList[String]\"></method>");

                strXML.append("\n");
                strXML.append("<method name=\"getNames\" parameters=\"[String]\" description=\"Gets proper nouns/names from text files and stores in ArrayList[String]\"></method>");                
            ...
            writeToFile(strXML.toString(), "C:\\test\\output\\test2.xml");
...
class test1
{
    ...
    public void outputToXML()
    {
        try
        {
            ...
            strXML.append("\n");
            strXML.append("</methods>\n</object>"); 
            writeToFile(strXML.toString(), "C:\\test\\output\\test1.xml");
